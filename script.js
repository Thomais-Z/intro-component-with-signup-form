...
button.addEventListener('click', function (e) {
  ...
  if (!curName) {
    document.getElementsByClassName('hidden-warning')[0].style.visibility =
      'visible';
  ...
  if (!curLastName) {
    document.getElementsByClassName('hidden-warning')[1].style.visibility =
      'visible';
  ...
  if (!validateEmail(curEmail)) {
    document.getElementsByClassName('hidden-warning')[2].style.visibility =
      'visible';
  ...
  if (!curPassword) {
    document.getElementsByClassName('hidden-warning')[3].style.visibility =
      'visible';
